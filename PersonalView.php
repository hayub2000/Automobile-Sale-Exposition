...
$sql = "SELECT * from staff natural join staff_contact where CNIC='$myusername'";
                    ...
                    <table class="table table-bordered">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td> ****** </td>
                                        <!-- <td><?php echo $pass ?></td> -->
                                        <!-- <td><a href="PersonalStaffUpdation.php?GetID=<?php echo $sID ?>"><body><i class="fa fa-pencil-square-o" style="font-size:24px;color:black"></i></body></a></td> -->
